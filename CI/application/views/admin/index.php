...
<!-- 左侧菜单 -->
		<div id="left_box">
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo site_url('index/home/index') ?>" class="pos" target="_blank">前台首页</a>
				        </li> 
				    </ul>
				  	<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo site_url('admin/admin/right') ?>" class="pos">系统信息</a>
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
		...
		<!-- 右侧 -->
		<div id="right">
			<iframe  frameboder="0" border="0" 	scrolling="yes" name="iframe" src="<?php echo site_url() . '/admin/admin/right' ?>"></iframe>
		</div>
	<!-- 底部 -->
	<div id="foot_box">
		<div class="foot">
